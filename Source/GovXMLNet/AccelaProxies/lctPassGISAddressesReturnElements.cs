...
namespace GovXMLNet
{
    public class lctPassGISAddressesReturnElements
    {
        // Members
        // TODO need example
        [XmlElement(ElementName = "returnElement")]
        public List<lctPassGISAddressesReturnElement> returnElements { get; set; }

        // Constructors
        public lctPassGISAddressesReturnElements()
        {
        }
    }
}
