...
// Defined in AccelaOperationRepository_Base as a local complex type
...
namespace GovXMLNet
{
    public class lctOperationsRequest
    {
        // Members
        // TODO need example
        [XmlElement(ElementName = "Operation")]
        public List<clsOperationRequest> Operation { get; set; }


        // Constructors
        public lctOperationsRequest()
        {
        }
    }
}
