...
namespace ProjectFirmaModels.Models
{
    public abstract partial class Tenant : IHavePrimaryKey
    {
        ...
        protected Tenant(int tenantID, string tenantName, string canonicalHostNameLocal, string canonicalHostNameQa, string canonicalHostNameProd, DateTime reportingYearStartDate, bool useFiscalYears, bool usesTechnicalAssistanceParameters, bool arePerformanceMeasuresExternallySourced, bool areOrganizationsExternallySourced, bool areFundingSourcesExternallySourced, bool showInTenantDropdown)
        {
            ...
            ShowInTenantDropdown = showInTenantDropdown;
        }
        ...
        public bool ShowInTenantDropdown { get; private set; }
        [NotMapped]
    ...
    {
        private TenantSitkaTechnologyGroup(int tenantID, string tenantName, string canonicalHostNameLocal, string canonicalHostNameQa, string canonicalHostNameProd, DateTime reportingYearStartDate, bool useFiscalYears, bool usesTechnicalAssistanceParameters, bool arePerformanceMeasuresExternallySourced, bool areOrganizationsExternallySourced, bool areFundingSourcesExternallySourced, bool showInTenantDropdown) : base(tenantID, tenantName, canonicalHostNameLocal, canonicalHostNameQa, canonicalHostNameProd, reportingYearStartDate, useFiscalYears, usesTechnicalAssistanceParameters, arePerformanceMeasuresExternallySourced, areOrganizationsExternallySourced, areFundingSourcesExternallySourced, showInTenantDropdown) {}
        public static readonly TenantSitkaTechnologyGroup Instance = new TenantSitkaTechnologyGroup(1, @"SitkaTechnologyGroup", @"sitka.localhost.projectfirma.com", @"sitka.qa.projectfirma.com", @"sitka.projectfirma.com", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
    ...
    public partial class TenantClackamasPartnership : Tenant
    {
        ...
        public static readonly TenantClackamasPartnership Instance = new TenantClackamasPartnership(2, @"ClackamasPartnership", @"clackamaspartnership.localhost.projectfirma.com", @"qa.clackamaspartnership.org", @"www.clackamaspartnership.org", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
    ...
    public partial class TenantInternationYearOfTheSalmon : Tenant
    {
        ...
        public static readonly TenantInternationYearOfTheSalmon Instance = new TenantInternationYearOfTheSalmon(4, @"InternationYearOfTheSalmon", @"iysdemo.localhost.projectfirma.com", @"iysdemo.qa.projectfirma.com", @"iysdemo.projectfirma.com", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
    ...
    public partial class TenantPeaksToPeople : Tenant
    {
        ...
        public static readonly TenantPeaksToPeople Instance = new TenantPeaksToPeople(6, @"PeaksToPeople", @"peakstopeople.localhost.projectfirma.com", @"qa-outcomes.peakstopeople.org", @"outcomes.peakstopeople.org", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
    ...
    public partial class TenantJohnDayBasinPartnership : Tenant
    {
        ...
        public static readonly TenantJohnDayBasinPartnership Instance = new TenantJohnDayBasinPartnership(7, @"JohnDayBasinPartnership", @"johndaybasinpartnership.localhost.projectfirma.com", @"qa.johndaybasinpartnership.org", @"www.johndaybasinpartnership.org", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
