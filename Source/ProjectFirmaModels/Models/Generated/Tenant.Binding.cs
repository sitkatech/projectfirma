...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class TenantNCRPProjectTracker : Tenant
    {
        ...
        public static readonly TenantNCRPProjectTracker Instance = new TenantNCRPProjectTracker(4, @"NCRPProjectTracker", @"ncrp.localhost.projectfirma.com", @"qa.northcoastresourcepartnershipprojects.org", @"www.northcoastresourcepartnershipprojects.org", DateTime.Parse("01/01/1990"), false, false, false, false, false, true);
    }
    ...
    public partial class TenantActionAgendaForPugetSound : Tenant
    {
        ...
        public static readonly TenantActionAgendaForPugetSound Instance = new TenantActionAgendaForPugetSound(11, @"ActionAgendaForPugetSound", @"actionagendatracker.localhost.projectfirma.com", @"qa-actionagendatracker.pugetsoundinfo.wa.gov", @"actionagendatracker.pugetsoundinfo.wa.gov", DateTime.Parse("01/01/1990"), false, false, true, true, true, false);
    }
