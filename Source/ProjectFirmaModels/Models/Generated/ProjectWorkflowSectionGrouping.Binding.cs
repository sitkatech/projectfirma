...
namespace ProjectFirmaModels.Models
{
    public abstract partial class ProjectWorkflowSectionGrouping : IHavePrimaryKey
    {
        ...
        public static readonly ProjectWorkflowSectionGroupingClassifications Classifications = ProjectWorkflowSectionGroupingClassifications.Instance;
        ...
        {
            All = new List<ProjectWorkflowSectionGrouping> { Overview, SpatialInformation, Accomplishments, Financials, AdditionalData, Partners, Classifications };
    ...
    public partial class ProjectWorkflowSectionGroupingClassifications : ProjectWorkflowSectionGrouping
    {
        private ProjectWorkflowSectionGroupingClassifications(int projectWorkflowSectionGroupingID, string projectWorkflowSectionGroupingName, string projectWorkflowSectionGroupingDisplayName, int sortOrder) : base(projectWorkflowSectionGroupingID, projectWorkflowSectionGroupingName, projectWorkflowSectionGroupingDisplayName, sortOrder) {}
        public static readonly ProjectWorkflowSectionGroupingClassifications Instance = new ProjectWorkflowSectionGroupingClassifications(7, @"Classifications", @"Classifications", 45);
    }
}