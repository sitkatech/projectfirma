...
namespace ProjectFirmaModels.Models
{
    public class ProjectOrganizationUpdateConfiguration : EntityTypeConfiguration<ProjectOrganizationUpdate>
    {
        ...
        public ProjectOrganizationUpdateConfiguration(string schema)
        {
            ...
            HasRequired(a => a.RelationshipType).WithMany(b => b.ProjectOrganizationUpdates).HasForeignKey(c => c.RelationshipTypeID).WillCascadeOnDelete(false); // FK_ProjectOrganizationUpdate_RelationshipType_RelationshipTypeID
        }
    }
}