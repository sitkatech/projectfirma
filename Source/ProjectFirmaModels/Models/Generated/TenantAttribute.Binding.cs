...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class TenantAttribute : IHavePrimaryKey, IHaveATenantID
    {
        ...
        {
            public const int ShortDisplayName = 100;
