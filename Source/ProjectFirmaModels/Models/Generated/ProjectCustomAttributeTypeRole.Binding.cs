...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class ProjectCustomAttributeTypeRole : IHavePrimaryKey, IHaveATenantID
    {
        ...
        /// </summary>
        public ProjectCustomAttributeTypeRole(int projectCustomAttributeTypeID, int roleID, int projectCustomAttributeTypeRolePermissionTypeID) : this()
        {
        ...
        /// </summary>
        public ProjectCustomAttributeTypeRole(ProjectCustomAttributeType projectCustomAttributeType, Role role, ProjectCustomAttributeTypeRolePermissionType projectCustomAttributeTypeRolePermissionType) : this()
        {
            // Mark this as a new object by setting primary key with special value
            this.ProjectCustomAttributeTypeRoleID = ModelObjectHelpers.MakeNextUnsavedPrimaryKeyValue();
        ...
        /// </summary>
        public static ProjectCustomAttributeTypeRole CreateNewBlank(ProjectCustomAttributeType projectCustomAttributeType, Role role, ProjectCustomAttributeTypeRolePermissionType projectCustomAttributeTypeRolePermissionType)
        {
            return new ProjectCustomAttributeTypeRole(projectCustomAttributeType, role, projectCustomAttributeTypeRolePermissionType);
        }
