...
namespace ProjectFirmaModels.Models
{
    public class GeospatialAreaPerformanceMeasureTargetConfiguration : EntityTypeConfiguration<GeospatialAreaPerformanceMeasureTarget>
    {
        ...
        public GeospatialAreaPerformanceMeasureTargetConfiguration(string schema)
        {
            ...
            HasOptional(a => a.PerformanceMeasureReportingPeriod).WithMany(b => b.GeospatialAreaPerformanceMeasureTargets).HasForeignKey(c => c.PerformanceMeasureReportingPeriodID).WillCascadeOnDelete(false); // FK_GeospatialAreaPerformanceMeasureTarget_PerformanceMeasureReportingPeriod_PerformanceMeasureReportingPeriodID
        }
    }
}