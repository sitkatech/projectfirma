...
{
    // Table [dbo].[TechnicalAssistanceRequest] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[TechnicalAssistanceRequest]")]
    public partial class TechnicalAssistanceRequest : IHavePrimaryKey, ICanDeleteFull
    {
        /// <summary>
        ...
        {
            dbContext.TechnicalAssistanceRequests.Remove(this);
        }
