...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class Person : IHavePrimaryKey, IHaveATenantID
    {
        ...
        protected Person()
        {
            ...
            this.PersonGridSettings = new HashSet<PersonGridSetting>();
            this.PersonLoginAccounts = new HashSet<PersonLoginAccount>();
        ...
        public List<string> DependentObjectNames() 
        {
            ...
            if(PersonGridSettings.Any())
            {
                dependentObjects.Add(typeof(PersonGridSetting).Name);
            }
        ...
        public void DeleteChildren(DatabaseEntities dbContext)
        {
            ...
            foreach(var x in PersonGridSettings.ToList())
            {
                x.DeleteFull(dbContext);
            }
        ...
        public virtual ICollection<PersonGridSetting> PersonGridSettings { get; set; }
        public virtual ICollection<PersonLoginAccount> PersonLoginAccounts { get; set; }
        [NotMapped]
        public PersonLoginAccount PersonLoginAccount { get { return PersonLoginAccounts.SingleOrDefault(); } set { PersonLoginAccounts = new List<PersonLoginAccount>{value};} }
