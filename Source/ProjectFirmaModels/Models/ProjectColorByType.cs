...
namespace ProjectFirmaModels.Models
{
    ...
    {
        public override string GetDisplayName() => FieldDefinitionEnum.TaxonomyTrunk.ToType().GetFieldDefinitionLabel();
    }
    ...
    {
        public override string GetDisplayName() => FieldDefinitionEnum.TaxonomyBranch.ToType().GetFieldDefinitionLabel();
    }
