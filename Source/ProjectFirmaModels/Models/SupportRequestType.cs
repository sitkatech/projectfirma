...
namespace ProjectFirmaModels.Models
{
    ...
    public partial class SupportRequestTypeHelpWithProjectUpdate
    {
        ...
        {
            return $"Can't figure out how to update my {Models.FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabel()}";
        }
    }
    ...
    public partial class SupportRequestTypeRequestProjectPrimaryContactChange
    {
        public override string GetSubjectLine()
        {
            return $"Request a change to a {Models.FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabel()}'s primary contact";
        }
    }
    ...
    public partial class SupportRequestTypeRequestPermissionToAddProjects
    {
        public override string GetSubjectLine()
        {
            return $"Request permission to add {Models.FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabelPluralized()}";
        }
    }
