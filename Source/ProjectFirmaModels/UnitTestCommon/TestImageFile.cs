/*-----------------------------------------------------------------------
<copyright file="TestImageFile.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirmaModels.UnitTestCommon
{
    public class TestImageFile : HttpPostedFileBase
    {
        ...
        public override int ContentLength => Capacity;

        public override string ContentType => FileResourceMimeType.FileResourceMimeTypeContentTypeName;

        public override string FileName => @"TempFile.jpg";
