/*-----------------------------------------------------------------------
<copyright file="DatabaseDirectAccessTestFixtureBase.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirmaModels.UnitTestCommon
{
    ...
    public class ProjectFirmaSqlDatabase
    {
        ...
        {
            _sqlDatabaseConnectionString = SitkaWebConfiguration.DatabaseConnectionString;
        }
