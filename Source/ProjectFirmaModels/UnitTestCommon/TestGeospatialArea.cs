/*-----------------------------------------------------------------------
<copyright file="TestGeospatialArea.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirmaModels.UnitTestCommon
{
    public static partial class TestFramework
    {
        public static class TestGeospatialArea
        {
            ...
            {
                return MakeTestName("Test GeospatialArea Name", GeospatialArea.FieldLengths.GeospatialAreaName);
            }
        }
    }
}
