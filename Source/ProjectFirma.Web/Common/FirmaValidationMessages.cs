...
namespace ProjectFirma.Web.Common
{
    public static class FirmaValidationMessages
    {
        ...
        public static string CompletionYearMustBePastOrPresentForCompletedProjects => $"{FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabelPluralized()} in the {ProjectStage.Completed.GetProjectStageDisplayName()} and {ProjectStage.PostImplementation.GetProjectStageDisplayName()} stages cannot have a {FieldDefinitionEnum.CompletionYear.ToType().GetFieldDefinitionLabel()} in the future.";
        ...
        public static string ImplementationYearMustBePastOrPresentForImplementationProjects => $"{FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabelPluralized()} in the {ProjectStage.Implementation.GetProjectStageDisplayName()} stage cannot have an {FieldDefinitionEnum.ImplementationStartYear.ToType().GetFieldDefinitionLabel()} in the future.";
