...
export interface IGrid {
    ...
    addRowCss(id: Id, css: string): void;
    removeRowCss(id: Id, css: string): void;
    addCellCss(row: Id, col: Id, css: string): void;
    ...
    getSpan(row: Id, col: Id): ISpan;
    removeSpan(row: Id, col: Id): void;
