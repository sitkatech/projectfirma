...
import { Dirs, EditorType, GridEvents, IAdjustBy, ICellRect, ICol, IContentList, ICoords, IEventHandlersMap, IGrid, IGridConfig, IRow, IScrollState, ISelection, ISpan, GridSystemEvents, ISystemEventHandlersMap, IColumnsWidth, ISortingState } from "./types";
...
export declare class Grid extends View implements IGrid {
    ...
    addCellCss(row: string, col: Id, css: string): void;
    removeCellCss(row: string, col: Id, css: string): void;
    ...
    edit(rowId: Id, colId: string | number, editorType?: EditorType): void;
    ...
    protected _sort(by: Id, dir?: Dirs): void;
