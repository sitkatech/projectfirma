/*-----------------------------------------------------------------------
<copyright file="IFirmaBaseFeatureWithContext.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace ProjectFirma.Web.Security
{
    public interface IFirmaBaseFeatureWithContext<in T>
    {
        ...
        bool HasPermissionByPerson(Person person);
    }
}
