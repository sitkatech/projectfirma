/*-----------------------------------------------------------------------
<copyright file="TaxonomyTierTwoPerformanceMeasureManageFeature.cs" company="Sitka Technology Group">
...
namespace ProjectFirma.Web.Security
{
    ...
    public class TaxonomyTierTwoPerformanceMeasureManageFeature : FirmaFeatureWithContext, IFirmaBaseFeatureWithContext<PerformanceMeasure>
    {
        ...
        public PermissionCheckResult HasPermission(Person person, PerformanceMeasure contextModelObject)
        {
            ...
            {
                return new PermissionCheckResult(String.Format("You don't have permission to Edit {0} for {1} {2}", MultiTenantHelpers.GetTaxonomyTierTwoDisplayNamePluralized(), MultiTenantHelpers.GetPerformanceMeasureName(), contextModelObject.PerformanceMeasureDisplayName));
            }
