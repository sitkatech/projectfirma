/*-----------------------------------------------------------------------
<copyright file="PerformanceMeasureExpectedFromProjectManageFeature.cs" company="Tahoe Regional Planning Agency">
...
namespace ProjectFirma.Web.Security
{
    ...
    public class PerformanceMeasureExpectedFromProjectManageFeature : FirmaFeatureWithContext, IFirmaBaseFeatureWithContext<Project>
    {
        ...
        public PerformanceMeasureExpectedFromProjectManageFeature()
            : base(new List<Role> { Role.SitkaAdmin, Role.Admin, Role.Normal, Role.ProjectOwner })
        {
