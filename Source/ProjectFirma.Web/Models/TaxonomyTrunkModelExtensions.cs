...
namespace ProjectFirma.Web.Models
{
    public static class TaxonomyTrunkModelExtensions
    {
        ...
        {
            var fancyTreeNode = new FancyTreeNode($"{UrlTemplate.MakeHrefString(taxonomyTrunk.GetDetailUrl(), taxonomyTrunk.GetDisplayName(), $"{FieldDefinitionEnum.TaxonomyTrunk.ToType().GetFieldDefinitionLabel()} {taxonomyTrunk.GetDisplayName()}")}",
