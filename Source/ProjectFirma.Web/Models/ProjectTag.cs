/*-----------------------------------------------------------------------
<copyright file="ProjectTag.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
    ...
    public partial class ProjectTag : IAuditableEntity
    {
        public string AuditDescriptionString
        {
            get
            {
                ...
                var tag = HttpRequestStorage.DatabaseEntities.AllGeospatialAreas.Find(TagID);
