...
namespace ProjectFirma.Web.Models
{
    public partial class ProposedProject : IAuditableEntity, IProject
    {
        ...
        {
            return IsMyProposedProject(person) || new ProposedProjectApproveFeature().HasPermissionByPerson(person) || new AdminReadOnlyViewEverythingFeature().HasPermissionByPerson(person);
        }
