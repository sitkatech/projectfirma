/*-----------------------------------------------------------------------
<copyright file="PerformanceMeasureMonitoringProgram.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
    ...
    public partial class PerformanceMeasureMonitoringProgram : IAuditableEntity
    {
        public string AuditDescriptionString
        {
            get
            {
                ...
                return $"PerformanceMeasure: {PerformanceMeasureID}, Monitoring Program: {monitoringProgramName}";
            }
        }
    }
}
