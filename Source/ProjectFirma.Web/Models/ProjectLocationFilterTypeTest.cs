/*-----------------------------------------------------------------------
<copyright file="ProjectLocationFilterTypeTest.cs" company="Tahoe Regional Planning Agency">
...
namespace ProjectFirma.Web.Models
{
    ...
    public class ProjectLocationFilterTypeTest
    {
        ...
        public void TestProjectLocationFilterTypesAddedAsProjectProperties()
        {
            ...
            var feature = Project.MappedPointsToGeoJsonFeatureCollection(new List<IProject> {project}, true).Features.First();
