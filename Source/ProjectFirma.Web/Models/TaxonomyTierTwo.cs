...
{
    public partial class TaxonomyTierTwo : IAuditableEntity, ITaxonomyTier, IHaveASortOrder
    {
        ...
        {
            get => TaxonomyTierTwoSortOrder;
            set => TaxonomyTierTwoSortOrder = value;
        }
        public int ID => TaxonomyTierTwoID;
