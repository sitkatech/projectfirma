/*-----------------------------------------------------------------------
<copyright file="ProposedProjectLocationStaging.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
    ...
    public partial class ProposedProjectLocationStaging : IProjectLocationStaging
    {
        ...
        public static List<ProposedProjectLocationStaging> CreateProposedProjectLocationStagingListFromGdb(FileInfo gdbFile, ProposedProject proposedProject, Person currentPerson)
        {
            ...
            var projectLocationStagings =
                featureClassNames.Select(x => new ProposedProjectLocationStaging(proposedProject, currentPerson, x, ogr2OgrCommandLineRunner.ImportFileGdbToGeoJson(gdbFile, x, true), true)).ToList();
