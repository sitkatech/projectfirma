/*-----------------------------------------------------------------------
<copyright file="TaxonomyLeafModelExtensions.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirma.Web.Models
{
    public static class TaxonomyLeafModelExtensions
    {
        ...
        {
            var fancyTreeNode = new FancyTreeNode($"{UrlTemplate.MakeHrefString(taxonomyLeaf.GetDetailUrl(), taxonomyLeaf.GetDisplayName(), new Dictionary<string, string> { { "aria-label", $"{FieldDefinitionEnum.TaxonomyLeaf.ToType().GetFieldDefinitionLabel()} {taxonomyLeaf.GetDisplayName()}" } })}",
