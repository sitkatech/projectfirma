/*-----------------------------------------------------------------------
<copyright file="ProposedProjectNote.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
    ...
    public partial class ProposedProjectNote : IAuditableEntity, IEntityNote
    {
        ...
        public string AuditDescriptionString
        {
            get
            {
                ...
                return $"{FieldDefinition.ProposedProject.GetFieldDefinitionLabel()}: {projectName}";
            }
        }
    }
}
