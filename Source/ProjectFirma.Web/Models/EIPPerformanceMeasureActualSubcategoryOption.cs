...
{
    public partial class EIPPerformanceMeasureActualSubcategoryOption : IAuditableEntity, IEIPPerformanceMeasureValueSubcategoryOption
    {
        public string AuditDescriptionString
        {
            get
            {
                ...
                return string.Format("Performance Measure: {0}, IndicatorSubcategory: {1}, IndicatorSubcategory Option: {2}", eipPerformanceMeasureName, indicatorSubcategoryName, indicatorSubcategoryOptionName);
            }
        }
    }
}