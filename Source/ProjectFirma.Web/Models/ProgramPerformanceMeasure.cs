...
{
    public partial class ProgramPerformanceMeasure : IAuditableEntity
    {
        public string AuditDescriptionString
        {
            get
            {
                ...
                return string.Format("Program: {0}, Performance Measure: {1}", projectName, performanceMeasureName);
            }
        }
    }
}