...
namespace ProjectFirma.Web.Models
{
    ...
    public partial class Tenant : IHavePrimaryKey
    {
        ...
        /// </summary>
        public Tenant(int tenantID, string tenantName) : this()
        {
        ...
        public Tenant(string tenantName) : this()
        {
            ...
            TenantID = ModelObjectHelpers.MakeNextUnsavedPrimaryKeyValue();
        ...
        {
            return new Tenant(default(string));
        }
