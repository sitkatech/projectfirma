...
namespace ProjectFirma.Web.Models
{
    ...
    public partial class ProposedProjectLocationStaging : IHavePrimaryKey, IHaveATenantID
    {
        ...
        /// </summary>
        public ProposedProjectLocationStaging(ProposedProject proposedProject, Person person, string featureClassName, string geoJson, bool shouldImport) : this()
        {
            // Mark this as a new object by setting primary key with special value
            this.ProposedProjectLocationStagingID = ModelObjectHelpers.MakeNextUnsavedPrimaryKeyValue();
            this.TenantID = HttpRequestStorage.Tenant.TenantID;
            ...
            this.Person = person;
            person.ProposedProjectLocationStagings.Add(this);
            this.FeatureClassName = featureClassName;
            this.GeoJson = geoJson;
            this.ShouldImport = shouldImport;
        }
        ...
        /// </summary>
        public static ProposedProjectLocationStaging CreateNewBlank(ProposedProject proposedProject, Person person)
        {
            return new ProposedProjectLocationStaging(proposedProject, person, default(string), default(string), default(bool));
        }
