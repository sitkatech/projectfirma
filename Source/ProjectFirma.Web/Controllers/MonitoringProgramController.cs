...
{
    public class MonitoringProgramController : LakeTahoeInfoBaseController
    {
        ...
        {
            var projectFirmaPage = ProjectFirmaPage.GetProjectFirmaPageByPageType(ProjectFirmaPageType.MonitoringProgramsList);
