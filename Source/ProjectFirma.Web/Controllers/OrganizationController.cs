...
namespace ProjectFirma.Web.Controllers
{
    public class OrganizationController : FirmaBaseController
    {
        ...
        public ViewResult Detail(OrganizationPrimaryKey organizationPrimaryKey)
        {
            ...
            var viewData = new DetailViewData(CurrentFirmaSession, organization, mapInitJson, projectLocationsLayerGeoJson, hasSpatialData, performanceMeasures, expendituresDirectlyFromOrganizationViewGoogleChartViewData, expendituresReceivedFromOtherOrganizationsViewGoogleChartViewData);
