...
using Summary = ProjectFirma.Web.Views.FocusArea.Summary;
using SummaryViewData = ProjectFirma.Web.Views.FocusArea.SummaryViewData;
...
namespace ProjectFirma.Web.Controllers
{
    public class FocusAreaController : FirmaBaseController
    {
        ...
        {
            var firmaPage = FirmaPage.GetFirmaPageByPageType(FirmaPageType.FocusAreasList);
