...
using Index = ProjectFirma.Web.Views.EIPPerformanceMeasure.Index;
using IndexGridSpec = ProjectFirma.Web.Views.EIPPerformanceMeasure.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Views.EIPPerformanceMeasure.IndexViewData;
...
namespace ProjectFirma.Web.Controllers
{
    public class EIPPerformanceMeasureController : FirmaBaseController
    {
        ...
        {
            var firmaPage = FirmaPage.GetFirmaPageByPageType(FirmaPageType.EIPPerformanceMeasuresList);
