/*-----------------------------------------------------------------------
<copyright file="ProjectUpdateControllerControllerTest.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace ProjectFirma.Web.Controllers
{
    ...
    public class ProjectUpdateControllerControllerTest
    {
        ...
        public void PathsToPartialViewsForDiffAreValid()
        {
            ...
            //Assert.That(File.Exists(WebPathToAbsolutePath(ProjectUpdateController.TransportationBudgetsPartialViewPath)));
