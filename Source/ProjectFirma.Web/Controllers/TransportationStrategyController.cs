...
using ProjectFirma.Web.Views.TransportationStrategy;
using ProjectFirma.Web.Security.Shared;
using ProjectFirma.Web.Views.Shared;
using ProjectFirma.Web.Views.Shared.TextControls;
using LtInfo.Common;
using LtInfo.Common.MvcResults;
using Index = ProjectFirma.Web.Views.TransportationStrategy.Index;
using IndexGridSpec = ProjectFirma.Web.Views.TransportationStrategy.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Views.TransportationStrategy.IndexViewData;
using Summary = ProjectFirma.Web.Views.TransportationStrategy.Summary;
using SummaryViewData = ProjectFirma.Web.Views.TransportationStrategy.SummaryViewData;
...
namespace ProjectFirma.Web.Controllers
{
    public class TransportationStrategyController : FirmaBaseController
    {
        ...
        {
            var firmaPage = FirmaPage.GetFirmaPageByPageType(FirmaPageType.TransportationStrategiesList);
