    ...
    public class LakeTahoeInfoBaseControllerTest
    {
        ...
        public void GivenControllerActionWhenHasIntegerIDParameterThenPreferPrimaryKeyObject()
        {
            ...
            var exceptions = new List<string>
            {
                ...
                "ProjectFirmaPageController.ProjectFirmaPageDetails",
                ...
                "ParcelController.ParcelAndTransactionMapPopup",
                "TdrTransactionController.NewAllocation",
                "TdrTransactionController.NewECMRetirement",
                "TdrTransactionController.NewLandbankAcquisition",
                "TdrTransactionController.NewTransfer",
                "TdrTransactionController.NewConversion",
                "TdrTransactionController.NewTransferWithBonusUnit",
                "TdrTransactionController.NewLandBankAcquisition",
                "TdrTransactionController.NewConversionWithTransfer",
