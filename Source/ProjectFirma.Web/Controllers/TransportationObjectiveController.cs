...
using ProjectFirma.Web.Views.TransportationObjective;
...
using Index = ProjectFirma.Web.Views.TransportationObjective.Index;
using IndexGridSpec = ProjectFirma.Web.Views.TransportationObjective.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Views.TransportationObjective.IndexViewData;
using Summary = ProjectFirma.Web.Views.TransportationObjective.Summary;
using SummaryViewData = ProjectFirma.Web.Views.TransportationObjective.SummaryViewData;

namespace ProjectFirma.Web.Controllers
{
    public class TransportationObjectiveController : FirmaBaseController
    {
        ...
        {
            var firmaPage = FirmaPage.GetFirmaPageByPageType(FirmaPageType.TransportationObjectivesList);
