        ...
        public void AllWebServicesHaveCorrectCsvColumns()
        {
            ...
            var testCases = new[]
            {
                ...
                new CsvColumnTestCase("GetProjectsByOrganization",
                    () =>
                        (CsvDownloadResult)
                            testSubject.GetProjectsByOrganization(WebServicesController.WebServiceReturnTypeEnum.CSV, WebServiceToken.WebServiceTokenForUnitTests, WebServices.SampleOrganizationID), "ProjectID,ProjectName,TaxonomyTierThree,TaxonomyTierTwo,TaxonomyLeaf,Stage,ProjectDescription,LeadImplementer,PlanningStartDate,ImplementationStartDate,EndDate,Latitude,Longitude,Datum,ProjectRegion,ProjectState,ProjectJurisdiction,ProjectWatershed,ProjectDetailUrl,ProjectFactSheetUrl"),
