...
namespace ProjectFirma.Web.Views.Organization
{
    public class DetailViewData : FirmaViewData
    {
            ...
            ViewGoogleChartViewData expendituresReceivedFromOtherOrganizationsViewGoogleChartViewData) : base(currentFirmaSession)
        {
            ...
            UserHasOrganizationManagePermissions = new OrganizationManageFeature().HasPermissionByPerson(currentFirmaSession.Person);
            ...
            ProjectsIncludingLeadImplementingGridSpec =
                new ProjectsIncludingLeadImplementingGridSpec(organization, currentFirmaSession.Person, false)
                {
            ...
            PerformanceMeasureChartViewDatas = performanceMeasures.Select(x => organization.GetPerformanceMeasureChartViewData(x, currentFirmaSession.Person)).ToList();

            NewFundingSourceUrl = SitkaRoute<FundingSourceController>.BuildUrlFromExpression(c => c.New());
            CanCreateNewFundingSource = new FundingSourceCreateFeature().HasPermissionByPerson(currentFirmaSession.Person) &&
            ...
            ProposalsGridSpec =
                new ProjectsIncludingLeadImplementingGridSpec(organization, currentFirmaSession.Person, true)
                {
