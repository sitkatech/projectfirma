...
namespace ProjectFirma.Web.Views.Organization
{
    public class IndexGridSpec : GridSpec<Models.Organization>
    {
        public IndexGridSpec(Person currentPerson, bool hasDeletePermissions)
        {
            ...
            Add("Abbreviation", a => a.OrganizationShortName, 100);
            ...
            Add($"# of {Models.FieldDefinition.Project.GetFieldDefinitionLabelPluralized()}", a => a.GetAllProjectOrganizations().Count, 90);
