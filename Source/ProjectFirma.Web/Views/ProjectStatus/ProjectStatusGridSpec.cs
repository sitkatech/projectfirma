...
namespace ProjectFirma.Web.Views.ProjectStatus
{
    public class ProjectStatusGridSpec : GridSpec<ProjectFirmaModels.Models.ProjectStatus>
    {
        public ProjectStatusGridSpec()
        {
            ...
            Add("edit", x => DhtmlxGridHtmlHelpers.MakeEditIconAsModalDialogLinkBootstrap(new ModalDialogForm(x.GetEditUrl(), ModalDialogFormHelper.DefaultDialogWidth, "Edit Status")), 30, DhtmlxGridColumnFilterType.None);
