...
namespace ProjectFirma.Web.Views.FundingSource
{
    public class IndexGridSpec : GridSpec<ProjectFirmaModels.Models.FundingSource>
    {
        public IndexGridSpec(FirmaSession currentFirmaSession, List<ProjectFirmaModels.Models.FundingSourceCustomAttributeType> fundingSourceCustomAttributeTypes)
        {
            ...
            Add(FieldDefinitionEnum.FundingSource.ToType().ToGridHeaderString(), a => $"{{ \"link\":\"{a.GetDetailUrl()}\",\"displayText\":\"{a.GetDisplayName()}\" }}", 320, AgGridColumnFilterType.HtmlLinkJson);
            Add(FieldDefinitionEnum.Organization.ToType().ToGridHeaderString(), a => $"{{ \"link\":\"{a.Organization.GetDetailUrl()}\",\"displayText\":\"{a.Organization.GetDisplayName()}\" }}", 300, AgGridColumnFilterType.HtmlLinkJson);
