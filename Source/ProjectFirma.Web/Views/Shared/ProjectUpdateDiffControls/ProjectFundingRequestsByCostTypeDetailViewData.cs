/*-----------------------------------------------------------------------
<copyright file="ProjectFundingRequestsByCostTypeDetailViewData.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
{
    public class ProjectFundingRequestsByCostTypeDetailViewData : FirmaUserControlViewData
    {
        ...
        public ProjectFundingRequestsByCostTypeDetailViewData(int? fundingTypeID, string fundingTypeDisplayName, List<FundingSourceBudgetAmount> fundingSourceRequestAmounts, decimal? noFundingSourceIdentifiedYet, int? planningDesignStartYear, int? completionYear)
        {
