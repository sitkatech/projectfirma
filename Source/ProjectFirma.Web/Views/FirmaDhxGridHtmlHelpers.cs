/*-----------------------------------------------------------------------
<copyright file="FirmaDhxGridHtmlHelpers.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
{
    public static class FirmaDhxGridHtmlHelpers
    {
        ...
        /// <returns></returns>
        public static HtmlString DhxGrid<T>(this HtmlHelper html, GridSpec<T> gridSpec, string gridName, string optionalGridDataUrl, string styleString, DhxGridResizeType dhtmlxGridResizeType)
        {
            var dhtmlxGridHeader = DhxGridHtmlHelpers.BuildDhxGridHeader(gridSpec, gridName, ExcelDownloadUrl);

            var saveGridSettingsUrl = SitkaRoute<GridSettingsController>.BuildUrlFromExpression(c => c.SaveGridSettings());

            var dhtmlxGrid = DhxGridHtmlHelpers.DhxGridImpl(gridSpec,
                gridName,
                optionalGridDataUrl,
