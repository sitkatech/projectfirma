...
namespace ProjectFirma.Web.Views.ProposedProject
{
    public class ProposedProjectGridSpec : GridSpec<Models.ProposedProject>
    {
        public ProposedProjectGridSpec(Person currentPerson)
        {
            ...
            Add(Models.FieldDefinition.ActionPriorityName.ToGridHeaderString(), x => x.ActionPriority == null ? string.Empty : x.ActionPriority.DisplayName, 300, DhtmlxGridColumnFilterType.Html);
            Add(Models.FieldDefinition.LeadImplementer.ToGridHeaderString(), x => UrlTemplate.MakeHrefString(x.LeadImplementerOrganization.GetSummaryUrl(), x.LeadImplementerOrganization.DisplayName), 175);
