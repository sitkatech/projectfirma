...
{
    public class EditGeospatialAreaTypeIntroTextViewModel : FormViewModel
    {
        [DisplayName("Page Content")]
        public HtmlString GeospatialAreaIntroContentHtmlString { get; set; }

        /// <summary>
        /// Needed by model binder
        /// </summary>
        public EditGeospatialAreaTypeIntroTextViewModel()
        {
        }
