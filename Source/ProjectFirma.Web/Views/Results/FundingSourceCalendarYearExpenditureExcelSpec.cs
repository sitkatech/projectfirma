/*-----------------------------------------------------------------------
<copyright file="FundingSourceCalendarYearExpenditureExcelSpec.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace ProjectFirma.Web.Views.Results
{
    public class FundingSourceCalendarYearExpenditureExcelSpec : ExcelWorksheetSpec<FundingSourceCalendarYearExpenditure>
    {
        ...
        {
            AddColumn(FieldDefinitionEnum.Organization.ToType().GetFieldDefinitionLabel(), x => x.OrganizationName);
            AddColumn(FieldDefinitionEnum.FundingSource.ToType().GetFieldDefinitionLabel(), x => x.FundingSourceName);
