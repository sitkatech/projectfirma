...
namespace ProjectFirma.Web.Views
{
    public abstract class FirmaViewData
    {
        ...
        private static LtInfoMenuItem BuildProgramInfoMenu(Person currentPerson)
        {
            ...
            {
                programInfoMenu.AddMenuItem(LtInfoMenuItem.MakeItem(new SitkaRoute<ProjectStewardOrganizationController>(c => c.Index()), currentPerson, $"{Models.FieldDefinition.ProjectStewardOrganizationIndex.GetFieldDefinitionLabelPluralized()}", "Group3"));
            }
