...
namespace ProjectFirma.Web.Views
{
    public abstract class FirmaViewData
    {
        ...
        private static LtInfoMenuItem BuildProjectsMenu(Person currentPerson)
        {
            ...
            projectsMenu.AddMenuItem(LtInfoMenuItem.MakeItem(new SitkaRoute<ProjectController>(c => c.Proposed()), currentPerson, $"{Models.FieldDefinition.ProposedProject.GetFieldDefinitionLabelPluralized()}", "Group3"));
            return projectsMenu;
        }
