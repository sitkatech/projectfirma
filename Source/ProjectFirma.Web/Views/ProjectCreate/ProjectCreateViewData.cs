...
namespace ProjectFirma.Web.Views.ProjectCreate
{
    public abstract class ProjectCreateViewData : FirmaViewData
    {
            ...
            ProposalSectionsStatus proposalSectionsStatus) : this(currentPerson)
        {
            ...
            var pagetitle = project.ProjectStage == ProjectStage.Proposal ? "Propose Project" : "Add Project";
            ...
            ProposalNotesUrl = SitkaRoute<ProjectCreateController>.BuildUrlFromExpression(x => x.NotesAndDocuments(project.ProjectID));
