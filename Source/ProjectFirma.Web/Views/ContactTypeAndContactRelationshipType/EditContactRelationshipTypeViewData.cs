...
namespace ProjectFirma.Web.Views.ContactTypeAndContactRelationshipType
{
    ...
    {
        public readonly List<ContactType> AllContactTypes;
        public EditContactRelationshipTypeViewData(List<ContactType> allContactTypes)
        {
            AllContactTypes = allContactTypes.OrderBy(x => x.ContactTypeName).ToList();
        }
    }
}
