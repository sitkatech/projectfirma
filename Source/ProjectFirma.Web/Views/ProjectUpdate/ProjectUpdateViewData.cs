...
namespace ProjectFirma.Web.Views.ProjectUpdate
{
    public class ProjectUpdateViewData : FirmaViewData
    {
                                     ...
                                     string currentSectionDisplayName) : base(currentFirmaSession, null)
        {
            ...
            ProjectUpdateStatus = currentFirmaSession.Person.IsApprover() ? projectUpdateStatus : new ProjectUpdateStatus(false, false, false, false, false, false, false, false, false, false, false, false, false, classificationSystemIsUpdated);
