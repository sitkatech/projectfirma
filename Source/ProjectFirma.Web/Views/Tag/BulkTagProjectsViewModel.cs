/*-----------------------------------------------------------------------
<copyright file="BulkTagProjectsViewModel.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace ProjectFirma.Web.Views.Tag
{
    public class BulkTagProjectsViewModel : FormViewModel
    {
        ...
        [Required]
        [StringLength(ProjectFirma.Web.Models.Tag.FieldLengths.TagName)]
