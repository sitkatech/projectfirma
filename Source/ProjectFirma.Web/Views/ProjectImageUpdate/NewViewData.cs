/*-----------------------------------------------------------------------
<copyright file="NewViewData.cs" company="Tahoe Regional Planning Agency and Environmental Science Associates">
...
namespace ProjectFirma.Web.Views.ProjectImageUpdate
{
    ...
    {
        public readonly ProjectFirmaModels.Models.ProjectUpdateBatch ProjectUpdateBatch;
        ...
        public NewViewData(ProjectFirmaModels.Models.ProjectUpdateBatch projectUpdateBatch, IEnumerable<SelectListItem> projectImageTimings)
        {
