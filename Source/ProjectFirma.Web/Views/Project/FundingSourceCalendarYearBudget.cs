...
{
    public class FundingSourceCalendarYearBudget
    {
        ...
        public readonly Dictionary<int, (decimal?, decimal?)> CalendarYearExpenditure;
        public string DisplayCssClass;

        public FundingSourceCalendarYearBudget(ProjectFirmaModels.Models.FundingSource fundingSource, Dictionary<int, decimal?> calendarYearExpenditure, string displayCssClass)
        {
