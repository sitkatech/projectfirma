...
namespace ProjectFirma.Web.Views.Project
{
    public class IndexGridSpec : GridSpec<Models.Project>
    {
        public IndexGridSpec(Person currentPerson, Dictionary<int, FundingTypeData> fundingTypes)
        {
            ...
            Add(Models.FieldDefinition.Watershed.ToGridHeaderStringPlural(Models.FieldDefinition.Watershed.GetFieldDefinitionLabelPluralized()), a => a.GetProjectWatershedNamesAsHyperlinks(), 200, DhtmlxGridColumnFilterType.Html);
