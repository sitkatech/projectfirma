...
namespace ProjectFirma.Web.Views.Project
{
    ...
    {
        public PerformanceMeasureExpectedExcelSpec(bool includeSubcategoryOptions)
        {
            AddColumn($"{FieldDefinitionEnum.Project.ToType().GetFieldDefinitionLabel()} ID", x => x.Project.ProjectID);
            AddColumn($"{FieldDefinitionEnum.ProjectName.ToType().GetFieldDefinitionLabel()}", x => x.Project.ProjectName);
            ...
            if (includeSubcategoryOptions)
            {
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 1 Name", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 1 ? x.GetPerformanceMeasureSubcategoryOptions()[0].PerformanceMeasureSubcategory.PerformanceMeasureSubcategoryDisplayName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 1 Option", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 1 ? x.GetPerformanceMeasureSubcategoryOptions()[0].PerformanceMeasureSubcategoryOption.PerformanceMeasureSubcategoryOptionName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 2 Name", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 2 ? x.GetPerformanceMeasureSubcategoryOptions()[1].PerformanceMeasureSubcategory.PerformanceMeasureSubcategoryDisplayName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 2 Option", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 2 ? x.GetPerformanceMeasureSubcategoryOptions()[1].PerformanceMeasureSubcategoryOption.PerformanceMeasureSubcategoryOptionName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 3 Name", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 3 ? x.GetPerformanceMeasureSubcategoryOptions()[2].PerformanceMeasureSubcategory.PerformanceMeasureSubcategoryDisplayName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 3 Option", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 3 ? x.GetPerformanceMeasureSubcategoryOptions()[2].PerformanceMeasureSubcategoryOption.PerformanceMeasureSubcategoryOptionName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 4 Name", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 4 ? x.GetPerformanceMeasureSubcategoryOptions()[3].PerformanceMeasureSubcategory.PerformanceMeasureSubcategoryDisplayName : string.Empty);
                AddColumn($"{FieldDefinitionEnum.PerformanceMeasureSubcategory.ToType().GetFieldDefinitionLabel()} 4 Option", x => x.PerformanceMeasure.HasRealSubcategories() && x.GetPerformanceMeasureSubcategoryOptions().Count >= 4 ? x.GetPerformanceMeasureSubcategoryOptions()[3].PerformanceMeasureSubcategoryOption.PerformanceMeasureSubcategoryOptionName : string.Empty);
            }
