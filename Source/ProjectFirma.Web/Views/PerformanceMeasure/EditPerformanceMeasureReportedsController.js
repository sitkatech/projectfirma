/*-----------------------------------------------------------------------
<copyright file="EditPerformanceMeasureReportedsController.js" company="Tahoe Regional Planning Agency">
...
-----------------------------------------------------------------------*/
angular.module("CorralApp").controller("EditPerformanceMeasureReportedController", function ($scope, angularModelAndViewData) {
    ...
    $scope.showRowValidationErrors = function (bulk) {
        var hasValidationErrors = _.includes($scope.AngularModel.PerformanceMeasureReportedsWithValidationErrors, bulk.PerformanceMeasureReportingPeriodLabel);
