...
using Edit = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.Edit;
using EditViewData = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.EditViewData;
using EditViewModel = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.EditViewModel;
using Index = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.Index;
using IndexGridSpec = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.IndexViewData;
using Summary = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.Summary;
using SummaryViewData = ProjectFirma.Web.Areas.EIP.Views.ActionPriority.SummaryViewData;
