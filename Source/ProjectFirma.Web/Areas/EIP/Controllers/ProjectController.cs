...
using MoreLinq;
using Index = ProjectFirma.Web.Areas.EIP.Views.Project.Index;
using IndexGridSpec = ProjectFirma.Web.Areas.EIP.Views.Project.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Areas.EIP.Views.Project.IndexViewData;
using Summary = ProjectFirma.Web.Areas.EIP.Views.Project.Summary;
using SummaryViewData = ProjectFirma.Web.Areas.EIP.Views.Project.SummaryViewData;
