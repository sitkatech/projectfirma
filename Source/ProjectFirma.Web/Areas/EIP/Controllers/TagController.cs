...
using Edit = ProjectFirma.Web.Areas.EIP.Views.Tag.Edit;
using EditViewData = ProjectFirma.Web.Areas.EIP.Views.Tag.EditViewData;
using EditViewModel = ProjectFirma.Web.Areas.EIP.Views.Tag.EditViewModel;
using Index = ProjectFirma.Web.Areas.EIP.Views.Tag.Index;
using IndexGridSpec = ProjectFirma.Web.Areas.EIP.Views.Tag.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Areas.EIP.Views.Tag.IndexViewData;
using Summary = ProjectFirma.Web.Areas.EIP.Views.Tag.Summary;
using SummaryViewData = ProjectFirma.Web.Areas.EIP.Views.Tag.SummaryViewData;
