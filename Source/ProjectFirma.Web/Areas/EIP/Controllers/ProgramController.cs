...
using ProjectFirma.Web.Areas.EIP.Views.Program;
...
using Edit = ProjectFirma.Web.Areas.EIP.Views.Program.Edit;
using EditViewData = ProjectFirma.Web.Areas.EIP.Views.Program.EditViewData;
using EditViewModel = ProjectFirma.Web.Areas.EIP.Views.Program.EditViewModel;
using Index = ProjectFirma.Web.Areas.EIP.Views.Program.Index;
using IndexGridSpec = ProjectFirma.Web.Areas.EIP.Views.Program.IndexGridSpec;
using IndexViewData = ProjectFirma.Web.Areas.EIP.Views.Program.IndexViewData;
using Summary = ProjectFirma.Web.Areas.EIP.Views.Program.Summary;
using SummaryViewData = ProjectFirma.Web.Areas.EIP.Views.Program.SummaryViewData;
