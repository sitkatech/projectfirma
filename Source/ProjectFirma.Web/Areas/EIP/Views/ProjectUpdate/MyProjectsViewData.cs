...
namespace ProjectFirma.Web.Areas.EIP.Views.ProjectUpdate
{
    public class MyProjectsViewData : EIPViewData
    {
        ...
        public MyProjectsViewData(Person currentPerson, ProjectFirmaPage projectFirmaPage, ProjectUpdateStatusGridSpec.ProjectUpdateStatusFilterTypeEnum projectUpdateStatusFilterType, string gridDataUrl) : base(currentPerson, projectFirmaPage)
        {
