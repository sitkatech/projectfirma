...
namespace ProjectFirma.Web.Areas.EIP.Views.Project
{
    public class IndexGridSpec : GridSpec<Models.Project>
    {
        public IndexGridSpec(Person currentPerson)
        {
            ...
            Add(FieldDefinition.LeadImplementer.ToGridHeaderString(), x => UrlTemplate.MakeHrefString(x.LeadImplementer != null ? x.LeadImplementer.GetSummaryUrl() : null, x.LeadImplementerName), 175);
            ...
            Add(FieldDefinition.NumberOfReportedPMRecords.ToGridHeaderString(), x => x.EIPPerformanceMeasureActuals.Count, 100);
            Add(FieldDefinition.NumberOfReportedExpenditureRecords.ToGridHeaderString(), x => x.ProjectFundingSourceExpenditures.Count, 100);
            ...
            Add(FieldDefinition.ProjectDescription.ToGridHeaderString(), x => x.ProjectDescription, 200);
            ...
            Add(FieldDefinition.OldEIPNumber.ToGridHeaderString(), x => x.OldEipNumber, 60);
