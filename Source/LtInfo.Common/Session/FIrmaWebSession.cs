...
namespace LtInfo.Common.Session
{
    ...
    {
        public const string TaurusSessionCookieName = "__Host-FirmaSessionCookie";
        private readonly ITaurusHttpContext _taurusHttpContext;
        private static readonly ILog Logger = LogManager.GetLogger(typeof(TaurusSession));

        public TaurusWebSession(ITaurusHttpContext taurusHttpTaurusHttpContext)
        {
