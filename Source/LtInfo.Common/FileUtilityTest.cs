...
namespace LtInfo.Common
{
    ...
    public class FileUtilityTest
    {
        ...
        public void GivenFileNotThereThenThrowException()
        {
            ...
            Assert.That(exception.Message, Does.Contain(_tempDir.FullName), "Exception should mention the directory");
            Assert.That(exception.Message, Does.Contain(fileFullNameRelativePath), "Exception should mention the file name");
        }
    }
}
