/*-----------------------------------------------------------------------
<copyright file="ModelListAbstract.cs" company="Environmental Science Associates">
...
namespace LtInfo.Common.Models
{
    public static class ModelListAbstract
    {
        ...
        public static object ToAgGridJsonCellDataTest<T>(this T dataObject, ColumnSpec<T> columnSpec)
        {
