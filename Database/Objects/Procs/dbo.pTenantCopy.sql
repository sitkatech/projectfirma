...
as
	insert into dbo.TenantAttribute(TenantID, TaxonomyLevelID, DefaultBoundingBox, MinimumYear, TenantDisplayName, ToolDisplayName, ShowProposalsToThePublic, RecaptchaPublicKey, RecaptchaPrivateKey)
	values
