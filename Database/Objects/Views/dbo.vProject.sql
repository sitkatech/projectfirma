...
as
	select	
            ...
            p.ProjectID, p.ActionPriorityID, p.ProjectNumber, p.ProjectName, p.ProjectDescription, ps.ProjectStageID, ps.ProjectStageDisplayName, p.ImplementationStartYear, p.CompletionYear, p.OldEipNumber, p.ImplementsMultipleProjects
	from dbo.Project p
