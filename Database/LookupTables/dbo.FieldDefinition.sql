...
(41, N'UnfundedNeed', N'No Funding Source Identified Yet', N'<p>The difference between the Total Cost and Secured Funding for a project or program.</p>'),
...
(80, N'ReportedExpenditure', N'Reported Financials', N'<p>An expenditure, tied to a Funding Source, as reported by the project implementer.</p>'),
...
(248, N'UnsecuredFunding', N'Targeted Funding', N'<p>Funding that has been identified for a project but has not been acquired such as planned grant applications.</p>'),
