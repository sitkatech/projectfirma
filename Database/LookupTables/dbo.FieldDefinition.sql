...
VALUES 
(1, N'TaxonomyTierOne', N'Taxonomy Tier One', NULL),
...
(5, N'TaxonomyTierThree', N'Taxonomy Tier Three', NULL),
...
(19, N'PerformanceMeasureType', N'Performance Measure Type', NULL),
...
(26, N'TaxonomyTierTwo', N'Taxonomy Tier Two', NULL),
...
(34, N'Sector', N'Sector', N'<p>A categorization of an organization as Local, State (California or Nevada), Federal or Private.</p>'),
...
(36, N'ProjectStage', N'Project Stage', NULL),
(39, N'ClassificationName', N'Classification Name', N'<p>-</p>'),
...
(44, N'Project', N'Project', N'<p>-</p>'),
(46, N'Classification', N'Classification', N'<p>The Focal Species of the Clackamas Partnership. Projects are identified as pertaining to one or more focal species.</p>'),
...
(76, N'ReportingYear', N'Reporting Year', N'The current year used for reporting purposes, which is defined as the previous calendar year until after November 1st of the present calendar year'),
...
(87, N'AssociatedTaxonomyTierTwos', N'Associated TaxonomyTierTwos', N'<p>External&nbsp;programs that are related to the content you are reviewing. You may wish to look up these programs to learn more.</p>'),
...
(92, N'LifecycleOperatingCost', N'Lifecycle Operating Cost', N'Sum of the annual operating cost from the Implementation Start Year to Completion Year. Not inflation adjusted.'),
(97, N'PerformanceMeasureChartTitle', N'Performance Measure Chart Title', N'<p>A short title for the Indicator (aka Performance Measure) used for charts throughout LT Info.</p>'),
...
(184, N'Region', N'Region (Geospatial, null),', NULL),
(228, N'PerformanceMeasureChartCaption', N'Performance Measure Chart Caption', NULL),
(236, N'MonitoringProgram', N'Monitoring Program', NULL),
...
(239, N'MonitoringProgramUrl', N'Monitoring Program Home Page', NULL),
(240, N'ClassificationDescription', N'Classification Description', N'<p>-</p>'),
(241, N'ClassificationGoalStatement', N'Classification Goal Statement', NULL),
(242, N'ClassificationNarrative', N'Classification Narrative', NULL),
(243, N'Taxonomy System Name', N'TaxonomySystemName', NULL),
(244, N'Taxonomy Tier One Display Name For Project', N'TaxonomyTierOneDisplayNameForProject', NULL)
