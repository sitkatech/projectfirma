...
values (373, 'When this option is set, fact sheets for projects that are in implementation will show expected performance measures if the project does not have reported performance measures. When not set fact sheets for projects in implementation will only display reported performance measures.')