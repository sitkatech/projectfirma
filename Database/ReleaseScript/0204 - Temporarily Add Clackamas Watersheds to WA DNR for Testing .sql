...
values (10, 'Watershed', 'Watersheds', 'Welcome to WA DNRs dummy watersheds page', 'These are dummy watersheds for WA DNR', 'https://localhost-mapserver.projectfirma.com/geoserver/WADNRForestHealth/wms', 'WADNRForestHealth:Watershed') 

-- Copy Clackamas watershed GeospatialAreas into WA DNR

insert into dbo.GeospatialArea
