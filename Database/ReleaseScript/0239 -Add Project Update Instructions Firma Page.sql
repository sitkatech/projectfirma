...
select TenantID, 56, '<p>Use this Project Update workflow to submit Project updates about the Project''s location, accomplishments, financial information, photos and more. Projects in the Planning/Design, Implementation, or Post-Implementation stage can be updated using this workflow.</p>
...
insert into dbo.FirmaPage(TenantID, FirmaPageTypeID, FirmaPageContent)
values 
(8, 56, '<p>Use this Project Update workflow to submit Project updates about the Project''s location, accomplishments, financial information, photos and more. Projects in the Planning/Design, Implementation, or Post-Implementation stage can be updated using this workflow.</p>
<p>The various aspects of a Project that are available for update can be seen on the left. Several of these sections are optional, but others are required:</p>
<ul>
    <li><strong>Basics:</strong> <i>You must enter the Project''s description, status, planning / design and implementation start dates</i></li>
    <li><strong>Simple Location:</strong> <i>You must input your Project''s location by plotting a point via an interactive map or provide a short location description, you may also provide a more detailed location in a later workflow page</i></li>
...
(11, 56, '<p>Use this Near Term Action Update workflow to submit Near Term Action updates about the Near Term Action''s location, accomplishments, financial information, photos and more. Near Term Actions in the Planning/Design, Implementation, or Post-Implementation stage can be updated using this workflow.</p>
