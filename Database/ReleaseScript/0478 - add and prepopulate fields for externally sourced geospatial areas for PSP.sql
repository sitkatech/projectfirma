...
values
(1, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(2, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(3, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(4, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(5, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(6, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(7, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(8, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(9, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(11, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>'),
(12, 85, '<p>Sourcing Geospatial Areas from external web services is enabled.  For each Geospatial Area listed below, please provide a query url that will return fields named NAME and GlobalID plus the geometry for each feature.</p>')