...
CREATE TABLE [dbo].[ProjectUpdateBatch](
	...
	[ShowEIPPerformanceMeasuresValidationWarnings] [bit] NOT NULL,
	[ShowExpendituresValidationWarnings] [bit] NOT NULL,
	[ShowTransportationBudgetsValidationWarnings] [bit] NOT NULL,
	...
	[EIPPerformanceMeasuresComment] [varchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[TransportationBudgetsComment] [varchar](1000) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ProjectUpdateStateID] [int] NOT NULL,
	[IsPhotosUpdated] [bit] NOT NULL,
	[BasicsDiffLog] [dbo].[html] NULL,
	[EIPPerformanceMeasureDiffLog] [dbo].[html] NULL,
	[ExpendituresDiffLog] [dbo].[html] NULL,
	[TransportationBudgetsDiffLog] [dbo].[html] NULL,
