...
GO
ALTER TABLE [dbo].[Person]  WITH CHECK ADD  CONSTRAINT [FK_Person_ContactType_ContactTypeID] FOREIGN KEY([ContactTypeID])
REFERENCES [dbo].[ContactType] ([ContactTypeID])
GO
ALTER TABLE [dbo].[Person] CHECK CONSTRAINT [FK_Person_ContactType_ContactTypeID]
GO
