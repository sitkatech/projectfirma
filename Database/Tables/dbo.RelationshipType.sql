...
GO
CREATE UNIQUE NONCLUSTERED INDEX [CK_RelationshipType_CanApproveProjects_OneTruePerTenant] ON [dbo].[RelationshipType]
(
	[TenantID] ASC,
	[CanApproveProjects] ASC
)
WHERE ([CanApproveProjects]=(1))
