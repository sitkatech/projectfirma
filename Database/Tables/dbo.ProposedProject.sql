...
GO
CREATE UNIQUE NONCLUSTERED INDEX [AK_ProposedProject_ProjectID] ON [dbo].[ProposedProject]
(
	[ProjectID] ASC
)
...
GO
CREATE SPATIAL INDEX [SPATIAL_ProposedProject_ProjectLocationPoint] ON [dbo].[ProposedProject]
(
