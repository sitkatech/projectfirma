...
(
 ...
 CONSTRAINT [AK_MonitoringProgram_MonitoringProgramID_TenantID] UNIQUE NONCLUSTERED 
(
	[MonitoringProgramID] ASC,
	[TenantID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
 CONSTRAINT [AK_MonitoringProgram_MonitoringProgramName_TenantID] UNIQUE NONCLUSTERED 
(
