...
GO
ALTER TABLE [dbo].[ProposedProjectClassification]  WITH CHECK ADD  CONSTRAINT [FK_ProposedProjectClassification_ProposedProject_ProposedProjectID_TenantID] FOREIGN KEY([ProposedProjectID], [TenantID])
REFERENCES [dbo].[ProposedProject] ([ProposedProjectID], [TenantID])
GO
ALTER TABLE [dbo].[ProposedProjectClassification] CHECK CONSTRAINT [FK_ProposedProjectClassification_ProposedProject_ProposedProjectID_TenantID]
GO
